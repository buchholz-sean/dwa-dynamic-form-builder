    ...
    inputs.forEach((input) => {
      ...
      if (input.type) {
        ...
        switch (input.type.toLowerCase()) {
          // Ternary expressions in the middle of each case add context
          // if user provides optional `id` or `for` properties
          case 'text':
          case 'password':
          case 'email':
          ...
          case 'submit':
            ...
            break;
          default:
          // If input doesn't match a supported value for `type`, we don't
          // add anything to formStr
